...
$dir = $PSScriptRoot
$source = Join-Path $dir "child_follow_demo.c"
$output = Join-Path $dir "child_follow_demo_x64.exe"
$object = Join-Path $dir "child_follow_demo_x64.obj"
...
if ($LASTEXITCODE -ne 0 -or -not (Test-Path -LiteralPath $output)) {
    throw "failed to build child-follow fixture"
}
