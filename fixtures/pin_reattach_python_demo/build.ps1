...
$dir = $PSScriptRoot
$source = Join-Path $dir "pin_reattach_python_demo.c"
$output = Join-Path $dir "pin_reattach_python_demo_x64.exe"
$object = Join-Path $dir "pin_reattach_python_demo_x64.obj"
...
if ($LASTEXITCODE -ne 0 -or -not (Test-Path -LiteralPath $output)) {
    throw "failed to build Pin reattach fixture"
}
