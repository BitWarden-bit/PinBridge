...
const dicts = {
  en: {
    ...
    probeModeHint: "Keeps session and low-frequency lifecycle/module observation only. Exact breakpoints, stepping, exception/syscall interception, execution traps, and instruction instrumentation are unavailable.",
  ...
  zh: {
    ...
    probeModeHint: "仅保留会话及低频生命周期/模块观察；精确断点、单步、异常/系统调用接管、执行监控和指令插桩不可用。",
    breakpointAt: "断点 @ ",
